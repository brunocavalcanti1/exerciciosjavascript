...
*/
 ...
 function addItem (itemInserir){
    myarray.push(itemInserir);
    return myarray;
 }
...
console.log(addItem([undefined, 'Javascript', {guitarra: 'Fender'}]));
...
var counterImpar = 10;
while(counterImpar++ < 20){
    counterImpar%2 === 1 ? console.log(counterImpar) : '';
}
